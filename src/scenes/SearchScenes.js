 ...
 */
    ...
    render() {
        const spinner = this.state.isLoading ? <ActivityIndicator size='large'/> : <Text></Text>
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.flowRight}>
                    <TextInput value={this.state.searchString} style={styles.searchInput} onChange={this._onSearchTextChanged} placeholder='Search via name or postcode'/>
